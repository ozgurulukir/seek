...
```bash
curl -fsSLO https://github.com/ozgurulukir/seek/releases/download/v0.3.0/seek_v0.3.0_linux-amd64.tar.gz
curl -fsSLO https://github.com/ozgurulukir/seek/releases/download/v0.3.0/SHA256SUMS.txt
grep seek_v0.3.0_linux-amd64.tar.gz SHA256SUMS.txt | sha256sum -c -
tar -xzf seek_v0.3.0_linux-amd64.tar.gz && ./seek --version
```
