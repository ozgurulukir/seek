...
| yake | MIT | |
| spacy | MIT | |
| spaCy models `xx_ent_wiki_sm` / `tr_core_news_sm` | MIT | downloaded by `setup.sh`/`setup.ps1`, not vendored |
...
Model weights are **not** vendored into the repo (D9): the platform setup scripts and
